...
import com.libaixieshi.parse.domain.Cell;
import com.libaixieshi.parse.domain.Enum.TableMatchMethodEnum;
import com.libaixieshi.parse.domain.Table;
import com.libaixieshi.parse.extractor.result.KVExtractedResult;
import com.libaixieshi.parse.extractor.unit.UnitConvert;
import com.libaixieshi.parse.util.TableUtil;
...
import static com.libaixieshi.parse.extractor.unit.UnitExtractConverter.handleAmountUnit;
import static com.libaixieshi.parse.extractor.unit.UnitExtractor.amountUnitExtract;
 ...
 */
@Slf4j
public class MapDocExtractor extends AbstractTableDocExtractor<KVExtractedResult> {

    public MapDocExtractor(ExtractorConfig config) {
        super(config);
    }
